...
This package contains the JODConverter webapp bundled with the Apache Tomcat 6.0.18 servlet
container. See TOMCAT-RUNNING.txt for how to start the server. See http://tomcat.apache.org
for more information about Apache Tomcat.
